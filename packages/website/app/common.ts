...
import {
  ...
  GetGroupRequestsInput,
  GetGroupRequestsOutput,
  GetGroupInvitationsInput,
  GetGroupInvitationsOutput,
...
export const apiCategories = {
  ...
  group: {
    ...
    apis: [
      ...
      { endpoint: 'quit_group', description: '退出群', inputStruct: QuitGroupInput, outputStruct: z.void() },
      {
  ...
  request: {
    ...
    apis: [
      ...
      {
        endpoint: 'get_group_requests',
        description: '获取群请求列表',
        inputStruct: GetGroupRequestsInput,
        outputStruct: GetGroupRequestsOutput,
      },
      {
        endpoint: 'get_group_invitations',
        description: '获取群邀请列表',
        inputStruct: GetGroupInvitationsInput,
        outputStruct: GetGroupInvitationsOutput,
      },
      {
